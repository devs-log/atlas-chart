...
import { EdgeProps, getSmoothStepPath, EdgeLabelRenderer, Position, BaseEdge } from 'reactflow';
...
StepEdgeComponent.displayName = 'StepEdge';

export default StepEdgeComponent;
